...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin5km() throws IOException {
    ...
    GetRestaurantsResponse test = new GetRestaurantsResponse(restaurantRepositoryServiceMock
        .findAllRestaurantsCloseBy(20.0, 30.0, LocalTime.of(3, 0), 1.0));
    
    when(restaurantService.findAllRestaurantsCloseBy(
        eq(new GetRestaurantsRequest(20.0, 30.0)), eq(LocalTime.of(3, 0))))
        .thenReturn(test);
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    final GetRestaurantsResponse allRestaurantsCloseByOffPeakHours =
        new GetRestaurantsResponse(restaurantList1);
    final GetRestaurantsResponse allRestaurantsCloseByPeakHours =
        new GetRestaurantsResponse(restaurantList2);
